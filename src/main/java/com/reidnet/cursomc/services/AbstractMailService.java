...
//	@Autowired
	...
	public  void sendNewPasswordEmail(Cliente cliente, String newPass) {
		SimpleMailMessage sm = prepareNewMailMesssagePassword(cliente, newPass);
	...
	protected SimpleMailMessage prepareNewMailMesssagePassword(Cliente cliente, String newPass) {
		SimpleMailMessage sm = new SimpleMailMessage();
