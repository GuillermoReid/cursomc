...
public class DbService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "g.guireid@gmail.com", "02806071720", TipoCliente.PESSOAFISICA, pe.encode("123"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "gui_reid@hotmail.com", "02806071720", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.addPerfil(Perfil.ADMIN);
				
		cli1.getTelefones().addAll(Arrays.asList("22559988", "11223366"));
		cli2.getTelefones().addAll(Arrays.asList("33658874", "478455587"));
		...
		Endereco e3 = new Endereco(null, "Avenida Floriano", "2106", null, "Centro", "22577-080", cli2, c2);
